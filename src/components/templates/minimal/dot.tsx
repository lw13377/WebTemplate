...
export default function DotTemplate({ content, themeColor, fontFamily }: TemplateProps) {
  ...
  return (
    ...
    >
      {/* Header — sits on top of dot grid */}
      <div
        style={{
      ...
      {/* Content area with subtle white background for readability */}
      <div style={{ backgroundColor: 'rgba(255,255,255,0.88)', padding: '16px 20px' }}>
        {/* Summary */}
        {summary && (
          <div style={sectionStyle}>
            <p style={{ ...bodyTextStyle, margin: 0, color: '#555' }}>{summary}</p>
          </div>
        )}
